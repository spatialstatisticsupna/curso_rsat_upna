...
```{r, cache=TRUE ,eval=TRUE, cache.path="cache/"}
dir.create("D:/rsat/regions")
dir.create("D:/rsat/DATABASE")
madrid <-new_rtoi("madrid",madrid.sf,"D:/rsat/regions","D:/rsat/DATABASE")
print(madrid)
...
madrid <- read_rtoi("D:/rsat/regions/madrid")
print(madrid)
```
